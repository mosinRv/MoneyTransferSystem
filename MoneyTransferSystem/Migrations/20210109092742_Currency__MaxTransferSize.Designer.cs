...
namespace MoneyTransferSystem.Migrations
{
    ...
    [Migration("20210109092742_Currency__MaxTransferSize")]
    partial class Currency__MaxTransferSize
    {
            ...
            modelBuilder.Entity("MoneyTransferSystem.Database.DbModels.Currency", b =>
                {
                    ...
                    b.Property<int>("MaxTransferSize")
                        .HasColumnType("integer")
                        .HasColumnName("max_transfer_size");
